      ...
      <ul className="profil__modale__timeline">
        <li className="profil__modale__timeline__li">
          ...
          <div class="relative">
            ...
            <label className="label label__simplon" htmlFor="simplon2">
              Simplon.co
            </label>
          </div>
          <div class="content">
            <p>
              Formation Concepteur d'application <br></br>-Titre professionnel
              RNCP niveau II <br></br>-Alternance 12 mois
              <br></br> -TypeScript, Architecture N-tiers , React Native{" "}
            </p>
          </div>
        </li>
        <li className="profil__modale__timeline__li">
          <input class="radio" id="simplon" name="formation" type="radio" />
          <div class="relative">
